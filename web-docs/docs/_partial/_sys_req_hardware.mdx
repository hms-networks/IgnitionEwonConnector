...
modules. This may include increasing the number of CPU cores, increasing the amount of RAM, increasing network
bandwidth, or increasing the amount of storage space available to Ignition.
