...
public class M2WebEwonUpdateTagValuesRequest extends M2WebEwonGetRequest {
  ...
  private static String getUpdateTagValuesRequestPath(KeyValue<String, String>[] tagValuePairs) {
    ...
    final int firstTagValuePairIndex = 0;
    for (int tagValuePairIndex = 0; tagValuePairIndex < tagValuePairs.length; tagValuePairIndex++) {
      // Append query string separator (? if first parameter)
      if (tagValuePairIndex == firstTagValuePairIndex) {
        requestPath.append("?");
      } else {
        requestPath.append("&");
      }
      ...
      // Append tag name
      final int tagIndex = tagValuePairIndex + 1;
      requestPath
          .append("TagName")
          .append(tagIndex)
          .append("=")
          .append(tagValuePairs[tagValuePairIndex].getKey());
      ...
      requestPath
          ...
          .append(tagIndex)
          .append("=")
          .append(tagValuePairs[tagValuePairIndex].getValue());
    }
