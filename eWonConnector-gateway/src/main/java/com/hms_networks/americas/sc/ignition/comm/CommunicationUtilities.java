...
public class CommunicationUtilities {
   ...
   */
  public static void setPostRequestBody(HttpPost httpPost, String httpPostRequestBody) {
    httpPost.setEntity(
        new StringEntity(httpPostRequestBody, CommunicationConstants.M2WEB_POST_REQUEST_CHARSET));
  }
  ...
  public static HttpPost createPostRequest(
    ...
    setPostRequestBody(request, httpPostRequestBody);
