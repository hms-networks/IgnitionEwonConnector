 ...
 * @version 1.0.0
 */
public class DMWebGetStatusRequest extends Talk2MRequest {
  ...
  /**
   * The parameters of the request to the DMWeb/Talk2M getstatus service, generated in the {@link
   ...
   * @since 1.0.0
   */
  public DMWebGetStatusRequest(String t2mtoken, String t2mdevid) {
    this.requestParams =
        new NameValuePair[] {
