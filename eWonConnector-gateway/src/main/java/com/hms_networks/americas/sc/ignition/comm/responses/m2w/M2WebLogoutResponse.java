 ...
 * @version 1.0.0
 */
public class M2WebLogoutResponse extends Talk2MResponse {
   ...
   *     M2WebLogoutResponse} class.
   * @since 1.0.0
   */
  public static M2WebLogoutResponse getFromJson(String json) throws JsonSyntaxException {
    return getFromJson(json, M2WebLogoutResponse.class);
  }
}
