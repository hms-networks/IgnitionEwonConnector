...
public class M2WebEwonEBDTagListResponse {
  ...
  private M2WebEwonEBDTagListResponse(boolean success, String errorText) {
   ...
   * @return An instance of {@link M2WebEwonEBDTagListResponse} parsed from the response
   *     string.
   */
  public static M2WebEwonEBDTagListResponse getFromString(String responseString) {
    ...
    return new M2WebEwonEBDTagListResponse(responseContainsSuccess, errorString);
  }
}
