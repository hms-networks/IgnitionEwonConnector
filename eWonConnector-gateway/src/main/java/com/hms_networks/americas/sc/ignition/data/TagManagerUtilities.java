...
public class TagManagerUtilities {
   ...
   *
   * @param value the {@link Object} tag value to convert
   * @param tagType the {@link EwonTagType} of the tag value
   * @throws NumberFormatException if the specified value cannot be converted to the specified
   *     numerical tag type
  ...
  public static String getTagNameForProviderFromDMWebEwon(
    ...
    if (cachedM2WebEwonTag != null) {
      ...
      // Show warning if debug enabled or if tag group sorting is enabled
