...
public class EwonUtil {
   ...
   /**
    * Hostname verifier user for HTTP connections. Note: Bypasses hostname verification.
    */
   ...
   /**
    * Convert ISO 8601 data string to Date object
   ...
   private static HttpURLConnection setupHttpConnection(String url, String method,
      ...
      // Set connection header values with specified values, if any
