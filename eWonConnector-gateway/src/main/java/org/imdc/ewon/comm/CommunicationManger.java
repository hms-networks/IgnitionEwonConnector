...
public class CommunicationManger {
   ...
   public EwonsData getData(Integer ewonId, Integer tagId, Integer limit, Date fromTime)
      ...
      // Verify integrity of Ewon identifier and add to parameter list
      if (ewonId != null) {
   ...
   /**
    * Synchronizes data with given last transaction identifier.
    * If <code>transactionID</code> equals null, continues without.
   ...
   public EwonsData syncData(Long transactionId) throws Exception {
      ...
      // Logs results from DataMailbox call and return deserialized data
