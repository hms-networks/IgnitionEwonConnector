...
public class TMResult
{
   ...
   /**
    * This constructor parses a Talk2M response and stores the Tag Names
    * and Tag Values in a hashmap
    *
   ...
   public TMResult(String data)
   {
      ...
      try (BufferedReader br = new BufferedReader(new StringReader(data)))
      {
         ...
         while ((line = br.readLine()) != null)
         {
            ...
            {
               TagValues.put(TagInfo[TAG_NAME_INDEX].replaceAll("\"", ""), TagInfo[TAG_VALUE_INDEX]);
            }
         }
