...
/**
 * This is a persistent record to keep track of the last transaction id synchronzed, along with a
 * few other stats.
 *
 */
public class EwonSyncData extends PersistentRecord {
   ...
   // This is the "lastSyncro" field reported from eWon. We keep track of it so we know across
   // restarts if we're up to date.
