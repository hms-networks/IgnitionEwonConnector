...
This module version is compatible with Ignition 7.9, but is no longer supported and does not receive updates. For an Ignition 8 compatible module go to [main](https://github.com/hms-networks/IgnitionEwonConnector/tree/main) branch.
